...
const UploadSubCategoryModel = ({close,fetchData}) => {
 ...
 const response = await uploadImage(file)
    ...
    try {
        ...
        const { data: responseData } = response  //„Nimm data aus response und nenne es responseData“
            ...
            <div className="w-full max-w-6xl bg-white p-4 rounded">
                ...
                <form className="my-3 grid gap-3" onSubmit={handleSubmitSubCategory}>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-3">
                            ...
                            <div className="px-4 py-1 border border-amber-400 text-amber-400 rounded hover:bg-amber-400  hover:text-neutral-900  cursor-pointer">
                                Upload Image
                                </div>
                                <input
                                    type="file"
