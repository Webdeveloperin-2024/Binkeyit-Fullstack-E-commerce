...
const ProductCardAdmin = ({ data,fetchProductData }) => {
    ...
    <div  className="w-36 p-3 bg-white rounded">
            ...
            <div className="grid grid-cols-2 gap-4 py-2">
                <button onClick={()=>setEditOpen(true)} className="border px-1 py-1 text-sm border-green-600 bg-green-100 text-green-800 rounded hover:bg-green-200 cursor-pointer">Edit</button>
                <button  onClick={()=>setOpenDelete(true)}  className="border px-px py-1 text-sm border-red-600 bg-red-100 text-red-800 rounded hover:bg-red-200 cursor-pointer">Delete</button>
            </div>
            ...
            {
                openDelete && (
                    <section className="fixed top-0 left-0 right-0 bottom-0 bg-neutral-600/60  z-50  p-4 flex items-center justify-center">
