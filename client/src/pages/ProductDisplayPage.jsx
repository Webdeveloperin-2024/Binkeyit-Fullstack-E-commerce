...
const ProductDisplayPage = () => {
    ...
    <section className="container mx-auto p-4 grid lg:grid-cols-2 ">
      <div className="">
        ...
        <div className="flex items-center justify-center gap-3 my-2">
          {data.image.map((img, index) => {
            return (
              <div
                key={img + index + "point"}
                className={`bg-slate-200  w-3 h-3   lg:w-5 lg:h-5 rounded-full ${index === image && "bg-slate-500"}`}
              ></div>
            );
          })}
        </div>
        ...
        <div className="grid relative">
          <div
            ref={imageContainer}
            className="flex gap-4 w-full relative z-10 overflow-x-auto scrollbar-none"
          >
            {data.image.map((img, index) => {
              return (
                <div
          ...
          <div className="w-full -ml-3   h-full flex justify-between  items-center absolute">
            <button
              ...
              className="bg-white z-10 p-1 rounded-full shadow-lg relative"
            >
              <FaAngleLeft />
            </button>
      ...
      <div className="p-4 lg:pl-7 text-base lg:text-lg">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            <div className="border border-green-500 p-4 py-2 rounded bg-green-50 w-fit">
  ...
  <p className="font-bold text-green-600 lg:text-2xl">
    ...
    <span className="text-base text-neutral-500">Discount</span>
        ...
        <div>
          <div className="flex items-center gap-4 my-4">
            ...
            <div className="text-sm">
              <div className="text-semibold">Superfast Delivery</div>
              <p>
                Get your order delivered to your doorstep at the at the earliest
                from dark store near you
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 my-4">
            ...
            <div className="text-sm">
              <div className="text-semibold">Best prices & offers</div>
              <p>
          ...
          <div className="flex items-center gap-4 my-4">
            ...
            <div className="text-sm">
              <div className="text-semibold">Wide Assortment</div>
              <p>
        ...
        {/**only mobile version */}
         <div className="my-4  gap-3  lg:hidden ">
          <div>
            <p className="font-semibold">Description</p>
            <p className="text-base">{data.description}</p>
          </div>
